...
DMA_INIT(_dma1_ch6, DMA1_BASE_ADDRESS, RCC_AHB_BIT_DMA1, DMA_CHANNEL_6,
        NVIC_IRQ_LINE_DMA1_CH6);
DMA_INIT(_dma1_ch7, DMA1_BASE_ADDRESS, RCC_AHB_BIT_DMA1, DMA_CHANNEL_7,
        NVIC_IRQ_LINE_DMA1_CH7);
